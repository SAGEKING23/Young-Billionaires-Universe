...
;(function ($, window, undefined) {
  ...
  $.fn.backstretch.defaults = {
    ...
    , alignX: 1                 // The x-alignment for the image, can be 'left'|'center'|'right' or any number between 0.0 and 1.0
    , alignY: 1                 // The y-alignment for the image, can be 'top'|'center'|'bottom' or any number between 0.0 and 1.0
  ...
  Backstretch.prototype = {
    ...
    resize: function () {
      try {
        ...
        var bgCSS = {left: auto, top: 0, right: 'auto', bottom: 'auto'}
